...
#define JITTER (Seconds (var->GetValue (-GPSR_MAXJITTER, GPSR_MAXJITTER))) 
#define FIRST_JITTER (Seconds (var->GetValue (0, GPSR_MAXJITTER))) //first Hello can not be in the past, used only on SetIpv4
